...
if __name__ == '__main__':
    for v in [os.environ.get('GOOGLE_APPLICATION_CREDENTIALS'),
              os.environ.get('SHEET_ID'), os.environ.get('RANGE'),
    ...
    print('Fetch google sheet id: {SHEET} ranged {RANGE}'.format(SHEET=os.environ.get('SHEET_ID'), RANGE=os.environ.get('RANGE')))
