...
RUN useradd skopeo; yum -y update; yum -y reinstall shadow-utils; yum -y install python3 python3-pip skopeo fuse-overlayfs --exclude container-selinux; yum -y clean all; rm -rf /var/cache/dnf/* /var/log/dnf* /var/log/yum*
